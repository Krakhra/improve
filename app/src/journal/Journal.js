...
class Journal extends React.Component{
  constructor(props){
    ...
    this.state={
      data:[
        {date:'16-12-2020',mood:1,title:'Injury',text:'Broke my leg'},
        {date:'14-12-2020',mood:9,title:'Work',text:'Slept in for work and got yelled at.'},
            ...
            <div style={{textAlign:'left',padding:'40px'}}>
              {this.state.data.map((item,i)=>
                <div>
                  ...
                  <p style={{color:'#fe5f55',fontSize:'16px'}}>Mood Score: {item.mood}</p>
